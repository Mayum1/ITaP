...
public class URLDepthPair 
{
  ...
  // Проверяет ссылку на формат заданный при помощи regex выражения URL_PREFIX
    ...
    // Принимает на вход пару из ссылки и глубины для хранения
    ...
    // Возвращает результат проверки ссылки на парсинг
